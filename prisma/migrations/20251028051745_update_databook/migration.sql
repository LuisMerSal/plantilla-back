/*
  ...
  - You are about to drop the `DatabookConsult` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
DROP TABLE "DatabookConsult";

-- CreateTable
CREATE TABLE "databook_consults" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "databook_consults_pkey" PRIMARY KEY ("id")
);
